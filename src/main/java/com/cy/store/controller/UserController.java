...
public class UserController {
    ...
    public JsonResult<PageInfo<User>> showUsers(@RequestParam(defaultValue = "1") Integer pageNum){
        JsonResult<PageInfo<User>> result = new JsonResult<>();
        List<User> sqlResult = new ArrayList<>();
        PageHelper.startPage(pageNum,5);
        System.out.println("...........开始分页");
        sqlResult = userService.showUsersByPage();
        //将查询到的结果重新封装到pageinfo中
        PageInfo<User> pageInfo = new PageInfo<>(sqlResult);
